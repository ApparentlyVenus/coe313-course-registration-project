...
-- Students (50)
('ahmad.karimi@lau.edu.lb',     'password123', 'STUDENT'),
('lara.haddad@lau.edu.lb',      'password123', 'STUDENT'),
('omar.salameh@lau.edu.lb',     'password123', 'STUDENT'),
('maya.nassar@lau.edu.lb',      'password123', 'STUDENT'),
('karim.abou@lau.edu.lb',       'password123', 'STUDENT'),
('nour.khalil@lau.edu.lb',      'password123', 'STUDENT'),
('hassan.ibrahim@lau.edu.lb',   'password123', 'STUDENT'),
('rima.khoury@lau.edu.lb',      'password123', 'STUDENT'),
('jad.mansour@lau.edu.lb',      'password123', 'STUDENT'),
('sara.azar@lau.edu.lb',        'password123', 'STUDENT'),
('ziad.farah@lau.edu.lb',       'password123', 'STUDENT'),
('dina.saad@lau.edu.lb',        'password123', 'STUDENT'),
('peter.gemayel@lau.edu.lb',    'password123', 'STUDENT'),
('lina.barakat@lau.edu.lb',     'password123', 'STUDENT'),
('mark.rizk@lau.edu.lb',        'password123', 'STUDENT'),
('tala.hajj@lau.edu.lb',        'password123', 'STUDENT'),
('firas.nasser@lau.edu.lb',     'password123', 'STUDENT'),
('nadine.karam@lau.edu.lb',     'password123', 'STUDENT'),
('ali.daher@lau.edu.lb',        'password123', 'STUDENT'),
('carla.hanna@lau.edu.lb',      'password123', 'STUDENT'),
('youssef.sleiman@lau.edu.lb',  'password123', 'STUDENT'),
('jana.moussa@lau.edu.lb',      'password123', 'STUDENT'),
('rami.chaaban@lau.edu.lb',     'password123', 'STUDENT'),
('hiba.torbey@lau.edu.lb',      'password123', 'STUDENT'),
('charbel.eid@lau.edu.lb',      'password123', 'STUDENT'),
('rana.jabbour@lau.edu.lb',     'password123', 'STUDENT'),
('elie.sarkis@lau.edu.lb',      'password123', 'STUDENT'),
('mia.bou@lau.edu.lb',          'password123', 'STUDENT'),
('tony.wehbe@lau.edu.lb',       'password123', 'STUDENT'),
('celine.nassar@lau.edu.lb',    'password123', 'STUDENT'),
('georges.frem@lau.edu.lb',     'password123', 'STUDENT'),
('sarah.akkawi@lau.edu.lb',     'password123', 'STUDENT'),
('tarek.hamdan@lau.edu.lb',     'password123', 'STUDENT'),
('joelle.azzi@lau.edu.lb',      'password123', 'STUDENT'),
('habib.chalhoub@lau.edu.lb',   'password123', 'STUDENT'),
('nadia.el-khoury@lau.edu.lb',  'password123', 'STUDENT'),
('mario.bitar@lau.edu.lb',      'password123', 'STUDENT'),
('luna.francis@lau.edu.lb',     'password123', 'STUDENT'),
('bassem.habib@lau.edu.lb',     'password123', 'STUDENT'),
('christelle.abi@lau.edu.lb',   'password123', 'STUDENT'),
('wael.darwish@lau.edu.lb',     'password123', 'STUDENT'),
('pamela.rahme@lau.edu.lb',     'password123', 'STUDENT'),
('karim.el-amine@lau.edu.lb',   'password123', 'STUDENT'),
('rouba.ghanem@lau.edu.lb',     'password123', 'STUDENT'),
('simon.abou-jaoude@lau.edu.lb','password123', 'STUDENT'),
('mirna.el-hajj@lau.edu.lb',    'password123', 'STUDENT');
...
('Nadia',      'El-Khoury',    'nadia.el-khoury@lau.edu.lb',   46),
...
('Karim',      'El-Amine',     'karim.el-amine@lau.edu.lb',    53),
('Rouba',      'Ghanem',       'rouba.ghanem@lau.edu.lb',      54),
('Simon',      'Abou-Jaoude',  'simon.abou-jaoude@lau.edu.lb', 55),
('Mirna',      'El-Hajj',      'mirna.el-hajj@lau.edu.lb',     56),
